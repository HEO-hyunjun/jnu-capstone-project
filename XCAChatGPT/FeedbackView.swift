...
4. 피드백은 (3.)에서 설명한 내용이 적절하게 표현되도록 해당 질문에 대한 모범 답변을 최대한 간략하게 제시하라.(제시한 문장이 예시임을 명시하라.)
예시: 해당 질문은 ??? 직무의 ??? 부분에 대해 평가하기 위한 질문입니다. 이 질문의 의도로는 ???, ??? 등의 항목을 면접 대상자에게서 살펴보기 위한 것으로, 이에 대해 ???에 대해 중점적으로 답변하는 것이 좋습니다. 만약 답변을 한다면 "???"과 같이 답변하는 것이 좋습니다.
"""
                    }else{
                        prompt +=
"""
...
3. 영어 회화를 배우는 입장에서 유용하다고 생각되는 단어에 대해 해당 문장의 부분과 단어의 뜻을 작성하라.
4. 영어 회화를 배우는 입장에서 유용하다고 생각되는 숙어 혹은 관용어 구문 대해 해당 문장의 부분과 숙어 혹은 관용어 구문의 뜻을 작성하라.
예시:
...
3. 피드백은 (2.)에서 설명한 내용이 적절하게 표현되도록 해당 질문에 대한 모범 답변을 최대한 간략하게 제시하라.(제시한 문장이 예시임을 명시하라.)
예시: 해당 질문은 ??? 부분에 대해 평가하기 위한 질문입니다. 이 질문의 의도로는 ???, ??? 등의 항목을 면접 대상자에게서 살펴보기 위한 것으로, 이에 대해 ???에 대해 중점적으로 답변하는 것이 좋습니다. 만약 답변을 한다면 "???"과 같이 답변하는 것이 좋습니다.
"""
                    print(prompt)
                    }else
                    {
